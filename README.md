...
> 
> 🚀 **求职作品集项目** | Portfolio Project
> 
> [🎬 演示指南](./DEMO_GUIDE.md) · [📖 API 文档](./docs/API.md) · [🏗️ 架构说明](./docs/ARCHITECTURE.md) · [🌐 在线 Demo](https://linguamate-pro.vercel.app)
...
*图：LinguaMate Pro 首页 - 简洁现代的设计，支持中英文切换*
...
![文本分析](./docs/screenshots/text-analysis.png)
...
![图片分析](./docs/screenshots/image-analysis.png)
...
![对话练习](./docs/screenshots/chat.png)

---

### 4️⃣ 学习历史追踪

记录所有学习活动，提供完整的学习进度管理。
...
- [🎬 演示指南](./DEMO_GUIDE.md) - 面试/演示场景使用指南
