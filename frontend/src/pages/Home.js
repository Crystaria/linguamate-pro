  ...
  const features = [
    {
      ...
      description: 'Upload text content for AI-powered linguistic analysis including vocabulary, grammar, and semantics',
      link: '/text-analysis',
    ...
    },
    {
      ...
      description: 'Upload textbook screenshots or images for OCR recognition and linguistic analysis',
      link: '/image-analysis',
    ...
    },
    {
      ...
      description: 'Practice language skills through real-time conversations with AI in authentic scenarios',
      link: '/chat-practice',
